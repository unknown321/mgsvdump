GetTypeIdByLocatorName() = [[non-lua function]];
GetUniqueIdByLocatorName() = [[non-lua function]];
IsDiamondByType() = [[non-lua function]];
IsExistLocator() = [[non-lua function]];
IsHerbByType() = [[non-lua function]];
IsMaterialByType() = [[non-lua function]];
RepopCountOperation() = [[non-lua function]];
ResetMoved() = [[non-lua function]];
SetAllCollectionInvisible() = [[non-lua function]];
SetDisabledInGame() = [[non-lua function]];
SetScriptDeclVars() = [[non-lua function]];
SetValidStation() = [[non-lua function]];
