...
_OnDemoDisable() = [[loadstring()]];
_OnDemoEnd() = [[loadstring()]];
_OnDemoInit() = [[loadstring()]];
_OnDemoInterrupt() = [[loadstring()]];
_OnDemoPlay() = [[loadstring()]];
_OnDemoSkip() = [[loadstring()]];
_Play() = [[upvalue]];
