...
["pushToParent"] = {
	["OnPlayerRespawn"] = [[upvalue]];
	["OnPlayerConnect"] = [[upvalue]];
	["OnRoundStart"] = [[upvalue]];
	["OnRulesetRoundStart"] = [[upvalue]];
	["PopulateSpawnChoices"] = [[upvalue]];
	["ClientPopulateLoadoutChoices"] = [[loadstring()]];
	["SearchPlayersOnSameTeam"] = [[loadstring()]];
};

["_scriptPath"] = "Freeplay_Spawning";
["hasInited"] = true;
["spawnGroupTag"] = "INITIAL";
