Unlock() = [[loadstring()]];
UnlockOnAllMissionTaskCompleted() = [[upvalue]];
UnlockOnAllQuestClear() = [[upvalue]];
UnlockOnBuddyFriendlyMax() = [[upvalue]];
UnlockOnMissionClear() = [[upvalue]];
...
["DOMINATION_TARGET_CP_NAME_LIST"] = {
