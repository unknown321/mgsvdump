_G["TppRevenge"]
	...
	_GetDecoyType()
	_GetMissionTendency()
	_GetUiParameterValue()
	_OnAnnihilated()
	_OnAntiSniperNoticed()
	_OnChangePhase()
	...
	_OnHeadShot()
	_OnReinforceRespawn()
	_OnSleepingComradeRecoverd()
	_OnSmokeDiscovered()
	_OnUnconscious()
	_ReceiveClearedDeployRevengeMission()
	_ReduceBlockedCount()
	_ReduceRevengePointByChickenCap()
	_ReduceRevengePointOther()
	_ReduceRevengePointStealthCombat()
	_SetEnmityLv()
	_SetMbInterrogate()
	_SetUiParameters()
	_SetupCamera()
	...
	ApplyMissionTendency()
	ApplyPowerSettingsForReinforce()
	CanUseReinforceVehicle()
	DecideRevenge()
	GetCameraRate()
	GetDecoyRate()
	GetMineRate()
	GetRevengeLvMax()
	GetRevengeTriggerName()
	Init()
	IsNoRevengeMission()
	IsNoStealthCombatRevengeMission()
	Messages()
	OnAllocate()
	OnEnterRevengeMineTrap()
	OnMessage()
	OnMissionClearOrAbort()
	OnReload()
	ReduceRevengePointOnMissionClear()
	RegisterCommonMineList()
	RegisterMineList()
	RegisterMissionMineList()
	ResetRevenge()
	SelectReinforceType()
	SelectRevengeType()
	SetRevengePoint()
